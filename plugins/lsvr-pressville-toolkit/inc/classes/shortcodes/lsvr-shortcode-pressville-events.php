<?php
/**
 * LSVR Pressville Events Shortcode
 */
if ( ! class_exists( 'Lsvr_Shortcode_Pressville_Events' ) ) {
    class Lsvr_Shortcode_Pressville_Events {
        ...
        public static function shortcode( $atts = array(), $content = null, $tag = '' ) {
            ...
            if ( ! empty( apply_filters( 'lsvr_pressville_events_shortcode_atts', array() ) ) ) {

                $default_atts = array_merge(
                    $default_atts,
                    array_fill_keys( array_column( apply_filters( 'lsvr_pressville_events_shortcode_atts', array() ), 'name' ), '' )
                );
            ...
            // Element class
            $class_arr = array( 'lsvr-pressville-post-grid lsvr-pressville-post-grid--events' );
            ...
            if ( function_exists( 'lsvr_events_get' ) ) {
                ...
                // Prepare query
                $limit = 0 === (int) $args['limit'] ? 1000 : $args['limit'];
                $query_args = array(
                    'period' => 'future',
                    'limit' => $limit,
                ...
                if ( ! empty( $args['category'] ) && is_numeric( $args['category'] ) && (int) $args['category'] > 0 ) {
                    ...
                    $category_id = get_term_by( 'slug', $args['category'], 'lsvr_event_cat', ARRAY_A );
                ...
                $event_occurrences = lsvr_events_get( $query_args );
                $event_occurrences = ! empty( $event_occurrences['occurrences'] ) ? $event_occurrences['occurrences'] : false;
            ...
            $lsvr_template_vars = array(
                ...
                'event_occurrences' => ! empty( $event_occurrences ) ? $event_occurrences : '',
                'class_arr' => $class_arr,
            ...
            if ( function_exists( 'lsvr_framework_load_template' ) ) {
                lsvr_framework_load_template( apply_filters( 'lsvr_shortcode_pressville_events_template_path', 'lsvr-pressville-toolkit/templates/shortcodes/pressville-events.php' ) );
            }
        ...
        public static function lsvr_shortcode_atts() {
            return array_merge( array(
                ...
                array(
                    ...
                    'default' => esc_html__( 'Upcoming Events', 'lsvr-pressville-toolkit' ),
                    'priority' => 10,
                ),
                ...
                array(
                    ...
                    'description' => esc_html__( 'Display events from a specific category.', 'lsvr-pressville-toolkit' ),
                    'priority' => 40,
                ),
                ...
                array(
                    ...
                    'description' => esc_html__( 'Link to events archive. Leave blank to hide.', 'lsvr-pressville-toolkit' ),
                    'default' => esc_html__( 'More Events', 'lsvr-pressville-toolkit' ),
                    'priority' => 50,
                ),
                ...
                array(
                    'name' => 'limit',
                    'type' => 'select',
                    'label' => esc_html__( 'Number of Events', 'lsvr-pressville-toolkit' ),
                    'description' => esc_html__( 'How many events should be displayed.', 'lsvr-pressville-toolkit' ),
                ...
                array(
                    ...
                    'description' => esc_html__( 'How many columns should be used to display events.', 'lsvr-pressville-toolkit' ),
            ...
            ), apply_filters( 'lsvr_pressville_events_shortcode_atts', array() ) );
        }
