		...
		public function add_event_date_filter() {
			...
			if ( $post_type === 'lsvr_event' ) {
				...
				<span class="lsvr-events-admin-view__date-filter">
					...
					<input type="text" class="lsvr-events-admin-view__date-filter-input lsvr-events-admin-view__date-filter-input--date-from" name="lsvr_events_admin_filter_date_from" id="lsvr_events_admin_filter_date_from"
					...
					<input type="text" class="lsvr-events-admin-view__date-filter-input lsvr-events-admin-view__date-filter-input--date-to" name="lsvr_events_admin_filter_date_to" id="lsvr_events_admin_filter_date_to"
